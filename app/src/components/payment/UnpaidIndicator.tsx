...
export function UnpaidIndicator({ unpaidMinorUnits, currency, onClick }: Props) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="tap-target-44 inline-flex items-center gap-1 rounded-full bg-amber-100 border border-amber-300 px-2.5 py-1 text-[0.75rem] font-semibold text-amber-900"
    >
