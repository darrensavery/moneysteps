          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-5 space-y-4">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full pl-3 pr-10 py-2.5 text-[0.875rem] rounded-xl border bg-[var(--color-surface-alt)] text-[var(--color-text)] placeholder-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--brand-primary)] ${pwError ? 'border-red-400' : 'border-[var(--color-border)]'}`}
              />
              <button
                type="button"
                tabIndex={-1}
