...
**3) Brand Personality**
- **5 adjectives:** Firm, Supportive, Neutral, Professional, Precise.
- **Tone of voice (bullets):**
    - "The Mediator & The Mentor."
    - Bank-grade precision mixed with family advisor empathy.
    - Collaborative and egalitarian for UK users.
    - Direct, hierarchical, and "no small talk" for Polish users.
- **Words we use:** Truth Engine, Immutable Ledger, Process Language, Financial Wellbeing, Contractual Integrity.
...
- **Proof points (bullets):**
    ...
    - AI coaching aligned with UK MaPS and Polish NSFE standards.

**5) Visual Identity**
- **Logo usage rules (bullets):**
    - The "M" form represents the duality of two households.
    - Negative space "Steps" symbolize the child's upward journey.
    - Maintain a "Safe Zone" equal to 20% of the logo's total width.
- **Colour palette:**
    - Deep Teal: #007A78
    - Ochre Gold: #D4A017
    - Charcoal: #2D3436
